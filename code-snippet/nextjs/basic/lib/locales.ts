...
export const locales: any = {
  ko: {
    ...
    validationDateRange: (startDate: any, endDate: any) =>
    ...
    scenarioResume: (scenarioId: any) => `'${scenarioId}' 시나리오 이어하기`,
    scenarioEnded: (scenarioId: any) => `'${scenarioId}' 시나리오가 종료되었습니다.`,
    scenarioStarted: (scenarioId: any) =>
    ...
    // Profile Modal
    greeting: (displayName: any) => `안녕하세요 ${displayName} 님`,
    screenStyle: "화면 스타일",
    lightMode: "라이트 모드",
    darkMode: "다크 모드",
    fontSize: "글자 크기",
    ...
    // Scenario Panel
    scenarioTitle: (scenarioId: any) => `시나리오: ${scenarioId}`,
    hide: "숨기기",
    end: "종료",
    select: "선택...",
  ...
  en: {
    ...
    scenarioResume: (scenarioId: any) => `Resume '${scenarioId}' scenario`,
    scenarioEnded: (scenarioId: any) => `Scenario '${scenarioId}' has ended.`,
    scenarioStarted: (scenarioId: any) => `Scenario '${scenarioId}' has started.`,
    ...
    // Profile Modal
    greeting: (displayName: any) => `Hello, ${displayName}`,
    ...
    // Scenario Panel
    scenarioTitle: (scenarioId: any) => `Scenario: ${scenarioId}`,
    hide: "Hide",
    end: "End",
    select: "Select...",
