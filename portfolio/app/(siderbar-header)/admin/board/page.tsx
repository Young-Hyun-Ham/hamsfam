...
export default function AdminBoardPage() {
  const modal = useAdminBoardStore((s) => s.modal);
  const close = useAdminBoardStore((s) => s.close);
  const query = useAdminBoardStore((s) => s.query);
  const paging = useAdminBoardStore((s) => s.paging);
  const fetchList = useAdminBoardStore((s) => s.fetchList);
