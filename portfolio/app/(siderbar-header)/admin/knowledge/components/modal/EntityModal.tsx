                ...
                {entries.map((row, idx) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="flex min-h-10 flex-wrap items-start gap-2 rounded-md border bg-white px-3 pt-1 pb-1">
                        {(row.synonyms ?? []).map((syn) => (
                          <span
                            key={syn}
                            className="inline-flex items-center gap-1 rounded-full border bg-gray-50 px-2 py-1 text-[12px] text-gray-800">
                            {syn}
                            <button
                              type="button"
                        ...
                        <input
                          className="min-w-[160px] flex-1 border-0 bg-transparent px-0 py-0 text-sm outline-none h-8"
                          value={row.synInput}
